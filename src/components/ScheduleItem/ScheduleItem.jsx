 ...
 const ScheduleItem = () => {
  return (
    <li className='scedule__item'>
      ...
      <h3 className="schedule__schedule-item">Читаем, поём и танцуем все вместе</h3>
      <h5 className="schedule__item-address-head">Адрес проведения</h5>
      <address className="schedule_item-address">г. Бердск, ул. Боровая, 111А, медицинский центр «Святитель Лука»</address>
